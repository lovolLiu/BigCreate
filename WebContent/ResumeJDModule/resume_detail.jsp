...
window.onload = writePositionIdToForm;
...
function writePositionIdToForm(){
	document.getElementById("hidden_positionId").setAttribute("value",GetQueryString("positionId"));
}
	...
	<div id="header">
		<div class="wrapper">
			...
			<ul class="reset" id="navheader">
				...
				<li><a href="companylist.html">发布职位</a></li>
				<li><a href="http://localhost:8080/BigCreate/ListPosition">找工作</a></li>
				<li><a href="h/toForum.html">关于我们</a></li>
			</ul>
		</div>
	</div>
	<!-- end #header -->
	<div class="content" style="float:none; margin: 70px auto; width:765px;">
		<dl class="company_center_content">
			...
			<dd>
				<form action="CreateResume" method="post" id="jobForm">
				<input type="hidden" value="the defaut value" id="hidden_positionId" name="positionId" />
					<table class="btm">
						<tbody>
							<tr>
